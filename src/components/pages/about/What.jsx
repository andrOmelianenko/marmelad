        ...
        <Animated>
            <Grid
                ...
                <Grid.Unit
                    ...
                    <Grid>
                        <Grid.Unit
                            size={{ ss: 4/4, ms: 4/8, ls: 9/18 }}
                            component={Item}
                            >
                            <Animated>
                                <ArticleHeading left>
                                    Запоминающиеся логотипы и корпоративная айдентика
                        ...
                        >
                            <Animated>
                                <ArticleHeading left>
                                    Человекоориентированный веб дизайн
                                    {/* Considered Web-design */}
                                </ArticleHeading>
                                <ArticleText>
                                    Мы тщательно подходим к разработке контента, опыта взаимодействия и графического дизайна. Это позволяет нам создать мощный механизм коммуникаций между пользователями и бизнесом в цифровой среде.
